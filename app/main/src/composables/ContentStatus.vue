...
<template>
	...
	<div
		...
		:class="{
			'border-green-200 bg-green-100 dark:border-green-800 dark:bg-green-900 scale-105': props.vm.isDragHovering,
			'dark:border-neutral-600': !props.vm.isDragHovering
		}">
		<svg
