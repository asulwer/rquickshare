...
<template>
	<div>
		<div class="relative w-[62px] h-[62px]">
			...
			<div class="h-14 w-14 rounded-full bg-white dark:bg-neutral-700 absolute top-0 left-0 bottom-0 right-0 m-auto">
				<svg
					v-if="item.state === 'Finished'" xmlns="http://www.w3.org/2000/svg" fill="currentColor" height="24"
					viewBox="0 -960 960 960" width="24" class="w-full h-full p-4">
					<!-- eslint-disable-next-line -->
                    <path d="M268-240 42-466l57-56 170 170 56 56-57 56Zm226 0L268-466l56-57 170 170 368-368 56 57-424 424Zm0-226-57-56 198-198 57 56-198 198Z" />
				</svg>
				<svg
					v-else-if="item.deviceType === 'Laptop'" xmlns="http://www.w3.org/2000/svg" fill="currentColor" height="24"
					viewBox="0 -960 960 960" width="24" class="w-full h-full p-4">
					<!-- eslint-disable-next-line -->
				...
				<svg
					v-else-if="item.deviceType === 'Phone'" xmlns="http://www.w3.org/2000/svg" fill="currentColor" height="24"
					viewBox="0 -960 960 960" width="24" class="w-full h-full p-4">
					<!-- eslint-disable-next-line -->
				...
				<svg
					v-else-if="item.deviceType === 'Tablet'" xmlns="http://www.w3.org/2000/svg" fill="currentColor" height="24"
					viewBox="0 -960 960 960" width="24" class="w-full h-full p-4">
					<!-- eslint-disable-next-line -->
				...
				<svg
					v-else xmlns="http://www.w3.org/2000/svg" fill="currentColor" height="24"
					viewBox="0 -960 960 960" width="24" class="w-full h-full p-4">
					<!-- eslint-disable-next-line -->
		...
		<p
			...
			<svg
				xmlns="http://www.w3.org/2000/svg" fill="currentColor" height="24"
